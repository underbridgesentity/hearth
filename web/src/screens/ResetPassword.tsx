  ...
  return (
    <div className="croft-scroll" style={{ position: 'absolute', inset: 0, zIndex: 100, background: '#F3F5FB', overflowY: 'auto' }}>
      <div style={{ minHeight: '100%', display: 'flex', flexDirection: 'column', padding: '72px 26px 40px' }}>
        ...
        <p style={{ fontSize: 14.5, color: '#717A90', margin: '0 0 26px' }}>Choose a new password for your Croft account.</p>
        ...
        <button onClick={onCancel} style={{ border: 'none', background: 'none', color: '#9AA3B5', fontWeight: 700, fontSize: 14, padding: '14px 0 0', cursor: 'pointer' }}>Back to sign in</button>
      </div>
    </div>
  );
}
